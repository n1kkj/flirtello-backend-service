alter table "content"."content_characters" add column "background_image_id" uuid;


alter table "content"."content_characters" add constraint "content_characters_background_image_id_fkey" FOREIGN KEY (background_image_id) REFERENCES content.directus_files(id) ON UPDATE CASCADE ON DELETE SET NULL not valid;

alter table "content"."content_characters" validate constraint "content_characters_background_image_id_fkey";
