alter table "content"."content_characters" add column "video_preview" uuid;

alter table "content"."content_characters" add constraint "content_characters_video_preview_foreign" FOREIGN KEY (video_preview) REFERENCES content.directus_files(id) ON DELETE SET NULL not valid;

alter table "content"."content_characters" validate constraint "content_characters_video_preview_foreign";
