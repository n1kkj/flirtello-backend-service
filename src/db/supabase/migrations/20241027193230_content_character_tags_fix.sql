alter table "content"."content_tags" drop constraint "content_tags_icon_foreign";
drop VIEW IF EXISTS "public"."characters";
alter table "content"."content_tags" alter column "icon" set data type character varying(255) using "icon"::character varying(255);
