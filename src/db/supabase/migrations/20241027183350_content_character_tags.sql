create sequence "content"."content_characters_content_tags_id_seq";

create sequence "content"."content_tags_id_seq";

create table "content"."content_characters_content_tags" (
    "id" integer not null default nextval('content.content_characters_content_tags_id_seq'::regclass),
...
create table "content"."content_tags" (
    "id" integer not null default nextval('content.content_tags_id_seq'::regclass),
...
alter table "content"."content_banners" alter column "is_active" set default true;

alter table "content"."llm_stats" alter column "chat_history" set data type json using "chat_history"::json;
...
CREATE UNIQUE INDEX content_characters_content_tags_pkey ON content.content_characters_content_tags USING btree (id);

CREATE UNIQUE INDEX content_tags_pkey ON content.content_tags USING btree (id);

alter table "content"."content_characters_content_tags" add constraint "content_characters_content_tags_pkey" PRIMARY KEY using index "content_characters_content_tags_pkey";

alter table "content"."content_tags" add constraint "content_tags_pkey" PRIMARY KEY using index "content_tags_pkey";

alter table "content"."content_characters_content_tags" add constraint "content_characters_content_tags_content_ch__34948cee_foreign" FOREIGN KEY (content_characters_id) REFERENCES content.content_characters(id) ON DELETE SET NULL not valid;

alter table "content"."content_characters_content_tags" validate constraint "content_characters_content_tags_content_ch__34948cee_foreign";

alter table "content"."content_characters_content_tags" add constraint "content_characters_content_tags_content_tags_id_foreign" FOREIGN KEY (content_tags_id) REFERENCES content.content_tags(id) ON DELETE SET NULL not valid;

alter table "content"."content_characters_content_tags" validate constraint "content_characters_content_tags_content_tags_id_foreign";

alter table "content"."content_tags" add constraint "content_tags_icon_foreign" FOREIGN KEY (icon) REFERENCES content.directus_files(id) ON DELETE SET NULL not valid;

alter table "content"."content_tags" validate constraint "content_tags_icon_foreign";

alter table "content"."content_tags" add constraint "content_tags_user_created_foreign" FOREIGN KEY (user_created) REFERENCES content.directus_users(id) not valid;

alter table "content"."content_tags" validate constraint "content_tags_user_created_foreign";

alter table "content"."content_tags" add constraint "content_tags_user_updated_foreign" FOREIGN KEY (user_updated) REFERENCES content.directus_users(id) not valid;

alter table "content"."content_tags" validate constraint "content_tags_user_updated_foreign";
