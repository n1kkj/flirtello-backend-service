...
- **nude**: Explicit nudity described or implied, but NO active sexual acts happening. Examples:
  - Fully undressed, naked, showing boobs/genitals/ass (but no sexual actions)
...
- **explicit**: Active sexual acts happening NOW in the conversation. Examples:
  ...
  - **Penetration** (vaginal, anal) → ALWAYS "explicit"
  - **Masturbation** (hand jobs, fingering) → ALWAYS "explicit"
...
8. Analyze the dialogue from bottom to top, focusing on the most recent messages
9. Consider the overall context, but prioritize what is happening NOW
